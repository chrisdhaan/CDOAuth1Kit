...
HOSTING_BASE_PATH="CDOAuth1Kit"
DOCS_ROOT="/$HOSTING_BASE_PATH/documentation/cdoauth1kit/"
...
<body>
  <p>Redirecting to <a href="$DOCS_ROOT">CDOAuth1Kit documentation</a>…</p>
</body>
</html>
EOF
...
<head>
  <meta charset="utf-8">
  <title>CDOAuth1Kit Documentation</title>
